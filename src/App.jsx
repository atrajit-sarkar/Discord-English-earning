...
import genZquizImage from "../gen-z-slang-quiz.png";
...
const QUIZZES = {
  ...
  "gen-z-slang": [
    {
      question: "Your friend tells you an unbelievable story about passing a difficult exam without studying, and adds, \"No ____!\" Which slang word fills in the blank to mean \"I'm telling the truth\"?",
      options: ["Cap", "Lie", "Way", "Joke"],
    },
    {
      question: "If someone is exceptionally good at flirting and effortlessly charming potential romantic partners, they are said to have a lot of what?",
      options: ["Game", "Rizz", "Swag", "Charm"],
    },
    {
      question: "You went on a few dates with someone, but suddenly they stopped replying to your texts and disappeared without any explanation. What is the modern slang term for this behavior?",
      options: ["Fading", "Dipping", "Ghosting", "Bailing"],
    },
    {
      question: "You are eating a delicious meal at a new restaurant. Which slang adjective would you use to describe the food as exceptionally good?",
      options: ["Fire", "Lit", "Dope", "Bussin'"],
    },
    {
      question: "If a friend has been playing video games or arguing on social media for 48 hours straight, which phrase would you use to tell them to step away from the screen and reconnect with reality?",
      options: ["Take a break", "Touch grass", "Go outside", "Log off"],
    }
  ]
};
...
const AVAILABLE_QUIZZES = [
  ...
  {
    id: "gen-z-slang",
    title: "Modern Spoken English and Gen Z Slang",
    description: "Understand the newest internet terminology to sound natural in casual, informal environments.",
    image: genZquizImage,
    tagline: "Modern Slang",
